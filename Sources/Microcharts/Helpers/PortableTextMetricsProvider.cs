...
namespace Microcharts
{
    ...
    /// (and so by <c>Microcharts.Maui</c> and the Windows target), and the fallback for the native
    /// <c>Microcharts.iOS</c>/<c>Microcharts.Droid</c> packages when no platform-precise provider is supplied.
    /// </summary>
    /// <remarks>
    ...
    /// representative of Microcharts label/legend/axis text (month names, signed numeric labels, single
