...
namespace Plugin.Maui.Microchart
{
    ...
    public abstract class Chart : INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// IEnumerable of <seealso cref="T:Plugin.Maui.Microchart.ChartEntry" /> corresponding of Entries of the chart.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Plugin.Maui.Microchart.Chart"/> class.
        /// </summary>
        public Chart()
        {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="T:Plugin.Maui.Microchart.Chart"/> is animated when entries change.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether this <see cref="T:Plugin.Maui.Microchart.Chart"/> is currently animating.
        /// </summary>
        ...
        /// <c>Plugin.Maui.Microchart.iOS</c>/<c>Plugin.Maui.Microchart.Droid</c> packages inject a platform-precise implementation.
        /// </summary>
