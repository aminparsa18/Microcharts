...
namespace Plugin.Maui.Microchart
{
    ...
    public class InvalidatedWeakEventHandler<TTarget> : IDisposable where TTarget : class
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Plugin.Maui.Microchart.InvalidatedWeakEventHandler`1"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether this <see cref="T:Plugin.Maui.Microchart.InvalidateWeakEventHandler`1"/> is alive.
        /// </summary>
        ...
        /// <summary>
        /// Releases all resource used by the <see cref="T:Plugin.Maui.Microchart.InvalidatedWeakEventHandler`1"/> object.
        /// </summary>
        /// <remarks>Call <see cref="Dispose"/> when you are finished using the
        /// <see cref="T:Plugin.Maui.Microchart.InvalidatedWeakEventHandler`1"/>. The <see cref="Dispose"/> method leaves the
        /// <see cref="T:Plugin.Maui.Microchart.InvalidatedWeakEventHandler`1"/> in an unusable state. After calling
        /// <see cref="Dispose"/>, you must release all references to the
        /// <see cref="T:Plugin.Maui.Microchart.InvalidatedWeakEventHandler`1"/> so the garbage collector can reclaim the memory
        /// that the <see cref="T:Plugin.Maui.Microchart.InvalidatedWeakEventHandler`1"/> was occupying.</remarks>
